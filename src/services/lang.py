...
class Lang:
    ...
    def __init__(self, default_language: (Language | str) = Language.ENGLISH):
        ...
        self.current_language = (
            default_language
            if isinstance(default_language, Language)
    ...
    def load_translations(self):
        ...
        for lang in Language:
            ...
            try:
                with open(
                    f'{self.translations_path}/{name}.json', encoding='utf-8'
                ) as f:
        ...
        for part in parsed_key:
            ...
            if data is None:
                raise AttributeError(
                    f"Key '{key}' not found in Lang ({cls._instance.current_language.value})."
                )
